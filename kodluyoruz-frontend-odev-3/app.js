...
let buttonsTexts = ["All", "Korea", "Japan", "China"];

const buttonDOM = (
  param
) => `<button class="btn btn-outline-dark btn-item" data-id="All" onclick="foodList('${buttonsTexts[param]}')">${buttonsTexts[param]}
</button>`;
...
for (let i = 0; i < buttonsTexts.length; i++) {
  buttons.insertAdjacentHTML("beforeend", buttonDOM(i));
}
